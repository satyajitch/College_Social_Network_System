...
<html lang="en">
  <head>
    ...
    <title>GIFT Social Network Profile</title>
...
$im="UPDATE `gift`.`register` SET `image` = '$image_file' WHERE `register`.`email` = '$email' AND `register`.`mobile` = '$mob'";
...
<?php
  ...
  <footer>
      <div class="footer">
        <p>GIFT Social Media  &copy 2023 Priyaranjan Debasis Satyajit</p>
      </div>
    </footer>
